...
Add Animal: User will be given a form of Animal information to fill out. Once filled out a new animal will be created and stored in the storage object.

View Animal: A popup window will appear showing all animals in storage and their attributes

Exit: All animals in storage will be saved to persistent storage and the program will terminate
