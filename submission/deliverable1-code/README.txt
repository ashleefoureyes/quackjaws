...
Compilation:
  Enter the following command (minus the backticks) to compile and build the
  program: `make`.
...
Operation Instructions:
  Click enter on initial popup and you will be given three options:
    ...
    Add Animal:
      The user will be given a form of animal information to fill out. Once
      filled out, a new animal will be created and stored in the storage object.

    View Animal:
      A popup window will appear showing all animals in storage and
      their attributes.

    Exit:
      All animals in storage will be saved to persistent storage and the
