...
"color: #ffffff\n"
"}"));
        gridLayout = new QGridLayout(StaffHomepage);
        ...
        bRunAlgorithm->setMaximumSize(QSize(150, 41));

        horizontalLayout_3->addWidget(bRunAlgorithm);

        bViewMatches = new QPushButton(StaffHomepage);
        bViewMatches->setObjectName(QStringLiteral("bViewMatches"));
        bViewMatches->setMinimumSize(QSize(150, 41));
        bViewMatches->setMaximumSize(QSize(150, 16777215));

        horizontalLayout_3->addWidget(bViewMatches);
        ...
        gridLayout->addWidget(bLogout, 8, 0, 1, 1);
    ...
    void retranslateUi(QDialog *StaffHomepage)
    {
        ...
        bViewMatches->setText(QApplication::translate("StaffHomepage", "View Matches", Q_NULLPTR));
