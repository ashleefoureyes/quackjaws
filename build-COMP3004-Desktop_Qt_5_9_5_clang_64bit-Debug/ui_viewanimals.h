...
public:
    ...
    void setupUi(QDialog *ViewAnimals)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 453, 663));
        ...
        widget1->setGeometry(QRect(10, 0, 421, 22));
        ...
        filterRabbits = new QCheckBox(widget1);
