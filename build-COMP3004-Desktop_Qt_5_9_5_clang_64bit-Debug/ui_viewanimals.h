...
public:
    ...
    void setupUi(QDialog *ViewAnimals)
    {
        ...
        ViewAnimals->setWindowIcon(icon);
        ViewAnimals->setStyleSheet(QLatin1String("QDialog{\n"
...
"}"));
        widget = new QWidget(ViewAnimals);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(10, 10, 440, 150));
        ...
        animalList = new QListWidget(ViewAnimals);
        animalList->setObjectName(QStringLiteral("animalList"));
        animalList->setGeometry(QRect(10, 490, 441, 150));
        animalList->setMinimumSize(QSize(0, 150));
        animalList->setMaximumSize(QSize(500, 150));
        layoutWidget = new QWidget(ViewAnimals);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(10, 460, 441, 25));
        ...
        tabWidget = new QTabWidget(ViewAnimals);
        tabWidget->setObjectName(QStringLiteral("tabWidget"));
        tabWidget->setGeometry(QRect(10, 160, 441, 301));
        ...
        bEditAnimal = new QPushButton(ViewAnimals);
        bEditAnimal->setObjectName(QStringLiteral("bEditAnimal"));
        bEditAnimal->setGeometry(QRect(190, 647, 80, 20));
    ...
    {
        ViewAnimals->setWindowTitle(QApplication::translate("ViewAnimals", "View Animals", Q_NULLPTR));
        ...
        bEditAnimal->setText(QApplication::translate("ViewAnimals", "Edit Animal", Q_NULLPTR));
    } // retranslateUi
